...
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        that.setData({
          ...
          alreadyOrder: res.data.data.god_all,
  ...
  confirmbuttom: function (e) {
    ...
    wx.request({
      ...
      data: {
        ...
        ids: that.data.goodsId, //	是	string	商品id（英文格式逗号分隔:1,2,3）
  ...
  addaddress: function () {
    var that = this
    wx.navigateTo({
      url: '../carAddress/carAddress?goodsId='+that.data.goodsId +"&num=" + that.data.num,
    })
  },
  bianJi: function (e) {
    console.log(e)
